...
public class SkillLoader {
    ...
    private SkillMetadata loadFromSkillMd(File skillMd, File skillDir) throws IOException {
        ...
        // 解析 endpoint 节点
        Object endpointObj = fm.get("endpoint");
        if (endpointObj instanceof java.util.Map) {
            @SuppressWarnings("unchecked")
            java.util.Map<String, Object> ep = (java.util.Map<String, Object>) endpointObj;
            meta.setEndpointPath(getStr(ep, "path", ""));
            meta.setAuthType(getStr(ep, "auth", "session"));
        }
